---
name: security-audit
description: OWASP Top 10、入力検証、インジェクション対策、安全な実装をカバーする Java 向けセキュリティチェックリストです。Spring、Quarkus、Jakarta EE、素の Java で利用できます。セキュリティレビュー、リリース前確認、脆弱性相談時に使います。
---

# Security Audit スキル

OWASP Top 10 と安全なコーディング実践に基づく Java アプリケーション向けのセキュリティチェックリストです。
...
## 使うタイミング
- セキュリティ観点のコードレビューをするとき
- 本番リリース前の確認をするとき
- ユーザーが「security」「vulnerability」「OWASP」について尋ねたとき
- 認証・認可コードをレビューするとき
- インジェクション脆弱性を確認したいとき
