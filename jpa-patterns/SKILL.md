...
Spring アプリケーションにおける JPA/Hibernate のベストプラクティスと典型的な落とし穴をまとめたスキルです。
...
## 使うタイミング
- ユーザーが「N+1 問題」「クエリが多すぎる」と話しているとき
- LazyInitializationException が発生しているとき
- フェッチ戦略（EAGER / LAZY）について相談したいとき
- トランザクション管理で問題があるとき
- エンティティ関連を設計したいとき
- クエリを最適化したいとき
