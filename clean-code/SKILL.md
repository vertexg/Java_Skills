---
name: clean-code
description: Clean Code の原則（DRY、KISS、YAGNI）、命名規則、関数設計、リファクタリングを扱います。「このコードをきれいにして」「リファクタリングして」「読みやすくして」「レビューして」「コード RV」などの依頼や、コード品質レビュー時に使います。
---

# Clean Code スキル

Clean Code の原則に沿って、読みやすく保守しやすいコードを書くためのスキルです。
...
## 使うタイミング
- ユーザーが「このコードをきれいにして」「リファクタリングして」「読みやすくして」と依頼したとき
- 保守性を重視したコードレビューをするとき
- 複雑さを下げたいとき
- 命名を改善したいとき
